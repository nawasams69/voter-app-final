...
# --- লোকেশন ডাটা ম্যাপিং (আপনার দেওয়া লজিক অনুযায়ী) ---
LOCATION_DATA = {
...
def show_details(voter):
    details = {
        ...
        "ওয়ার্ড (ইউনিয়ন)": voter.get('ward_union'),
        "ইউনিয়ন/ওয়ার্ড": voter.get('union_ward'),
...
# --- ধাপ ১: এলাকা নির্বাচন (Hierarchy Logic) ---
st.subheader("১. এলাকা নির্বাচন")
col_loc1, col_loc2, col_loc3 = st.columns(3)

with col_loc1:
    # প্রশ্ন ১: মেইন ক্যাটাগরি
    main_cat = st.selectbox("প্রশাসনিক এলাকা", list(LOCATION_DATA.keys()))

with col_loc2:
    # প্রশ্ন ২: সাব-ক্যাটাগরি (১ম প্রশ্নের ওপর ভিত্তি করে)
    sub_cat_options = list(LOCATION_DATA[main_cat].keys())
    sub_cat = st.selectbox("ওয়ার্ড বা ইউনিয়ন", sub_cat_options)

with col_loc3:
    # প্রশ্ন ৩: ভোটার এলাকা (২য় প্রশ্নের ওপর ভিত্তি করে)
    # এটিই আমাদের ফাইনাল সার্চ কি-ওয়ার্ড (voter_area_name)
...
if search_btn:
    if not selected_area_name:
        st.warning("⚠️ দয়া করে ভোটার এলাকা নির্বাচন করুন।")
        ...
        with st.spinner("তথ্য খোঁজা হচ্ছে..."):
            try:
                ...
                if not data:
                    st.error(f"❌ '{selected_area_name}' এলাকায় এই তথ্যের কোনো ভোটার পাওয়া যায়নি।")
                else:
